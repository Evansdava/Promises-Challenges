 ...
 *
 * If greet() fails, the .catch will trigger, exiting the promise and printing
 * 'Received an error!'
 * 'Name must be a string!'
 * which is what happens, and uppercaser() does not run.
 *
 ...
 *    run the code again.
 *
 * It will print the greeting line, but throw an error afterward
 *
 *
...
const name = 'Ducky'
const myStr = 'Make School is Awesome!!!'

greet(name)
  .then((greetResult) => {
    console.log(greetResult)
    return uppercaser(myStr)
  })
